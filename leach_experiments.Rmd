...
newOM <- quantile(leachH$logOM,na.rm=T,0.5)
...
A large proportion of Cu was removed from high metal stormwater, but the removal efficiency differed between retrofit and new build biorentention cell soils (p=0.002). Retrofit cells only removed 77% of added Cu but new builds removed 90%. Soils with greater OM have less metal removal. In new builds, low OM (10%) removed 92% of Cu but high OM (90%) removed 84%. 
