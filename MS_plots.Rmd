...
plot(Curemove~Retrofit,data=leachH,col=c("white","grey50"),ylim=c(0,1),las=1)
...
plot(Pbremove~Retrofit,data=leachH,ylim=c(0,1),yaxt="n",col=c("white","grey50"))
mtext("Pb",3,0,cex=0.8)
mtext("High metal stormwater",3,2)
plot(Znremove~Retrofit,data=leachH,ylim=c(0,1),yaxt="n",col=c("white","grey50"))
mtext("Zn",3,0,cex=0.8)

par(mar=c(0,0.25,4.25,0.25))
plot(Curemove~Retrofit,data=leachL,ylim=c(0,1),las=1,col=c("white","grey50"))
mtext("Proportion removed",2,3)
mtext("Cu",3,0,cex=0.8)
plot(Pbremove~Retrofit,data=leachL,ylim=c(0,1),yaxt="n",col=c("white","grey50"))
mtext("Pb",3,0,cex=0.8)
mtext("Low metal stormwater",3,2)
plot(Znremove~Retrofit,data=leachL,ylim=c(0,1),yaxt="n",col=c("white","grey50"))
mtext("Zn",3,0,cex=0.8)
