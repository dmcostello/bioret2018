...
plot(Clay~offAgeR,data=fullsoil,log="y",yaxt="n",xaxt="n",pch=c(5,19)[Retrofit],cex=1.1,ylim=c(0.7,100),xlab="",ylab="")
lines(xAge,10^yClay)
logaxis(0,2,2)
axis(1,labels=F)
...
par(mar=c(2,2,0,0))
plot(OM~offAgeR,data=fullsoil,log="y",yaxt="n",pch=c(5,19)[Retrofit],cex=1.1,ylim=c(0.7,100),xlab="",ylab="")
logaxis(0,2,2)
